...
public class Bus extends Car {
    ...
    Bus(Road road) {
        ...
        try {
            this.image1 = ImageIO.read(new File("resources/bus1.png"));
            this.image2 = ImageIO.read(new File("resources/bus2.png"));
            this.image3 = ImageIO.read(new File("resources/bus3.png"));
            this.image4 = ImageIO.read(new File("resources/bus4.png"));
