...
public class Sedan extends Car {
    ...
    Sedan(Road road) {
        ...
        try {
            this.image1 = ImageIO.read(new File("resources/sedan1.png"));
            this.image2 = ImageIO.read(new File("resources/sedan2.png"));
            this.image3 = ImageIO.read(new File("resources/sedan3.png"));
            this.image4 = ImageIO.read(new File("resources/sedan4.png"));
