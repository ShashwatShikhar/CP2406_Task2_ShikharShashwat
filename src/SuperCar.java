...
public class SuperCar extends Car {
    ...
    SuperCar(Road road) {
        ...
        try {
            this.image1 = ImageIO.read(new File("resources/supercar1.png"));
            this.image2 = ImageIO.read(new File("resources/supercar2.png"));
            this.image3 = ImageIO.read(new File("resources/supercar3.png"));
            this.image4 = ImageIO.read(new File("resources/supercar4.png"));
